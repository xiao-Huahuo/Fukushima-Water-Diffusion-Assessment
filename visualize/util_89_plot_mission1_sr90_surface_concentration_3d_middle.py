...
def plot_sr90_surface_concentration_3d_middle(input_paths, output_dir):
    os.makedirs(output_dir, exist_ok=True)

    nuclide_name = "Sr90"
    time_description = "middle"
    depth_target = 0 # 0 for surface, 50 for 50m, 200 for 200m
    output_filename_suffix = "surface_concentration_3d_middle"
...
if __name__ == "__main__":
    ...
    plot_sr90_surface_concentration_3d_middle(test_input_paths, test_output_dir)