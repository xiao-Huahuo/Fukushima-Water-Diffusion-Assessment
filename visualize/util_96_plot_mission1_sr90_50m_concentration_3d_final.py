...
def plot_sr90_50m_concentration_3d_final(input_paths, output_dir):
    os.makedirs(output_dir, exist_ok=True)

    nuclide_name = "Sr90"
    time_description = "final"
    depth_target = 50 # 0 for surface, 50 for 50m, 200 for 200m
    output_filename_suffix = "50m_concentration_3d_final"
...
if __name__ == "__main__":
    ...
    plot_sr90_50m_concentration_3d_final(test_input_paths, test_output_dir)