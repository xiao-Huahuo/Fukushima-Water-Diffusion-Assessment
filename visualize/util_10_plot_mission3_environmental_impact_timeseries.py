...
def plot_environmental_impact_timeseries(input_paths, output_dir):
    ...
    try:
        ...
        plt.title('不同处理方案下环境影响随时间变化 (30年)', fontsize=16, fontweight='bold')
        ...
        output_path = os.path.join(output_dir, "mission3_environmental_impact_timeseries.png")
...
if __name__ == "__main__":
    ...
    plot_environmental_impact_timeseries(test_input_paths, test_output_dir)
